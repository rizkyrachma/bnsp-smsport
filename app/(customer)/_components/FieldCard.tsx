...
const FieldCard: React.FC<FieldCardProps> = ({
  ...
  return (
    <div
      ...
      className={`bg-paper-white border rounded-3xl p-4 sm:p-5 md:p-6 transition-all space-y-3 sm:space-y-4 ${
        isSelectedCourt
    ...
    >
      {/* 1. Compact Landscape Thumbnail with Court Name overlaid at bottom-left */}
      <div className="w-full aspect-[21/9] sm:aspect-[24/7] max-h-[140px] sm:max-h-[160px] md:max-h-[180px] rounded-2xl overflow-hidden relative border border-fog bg-carbon/5">
        <Image
          src={imageAsset.url}
          alt={imageAsset.alt}
          fill
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-carbon/90 via-carbon/30 to-transparent pointer-events-none flex flex-col justify-end p-3 sm:p-4">
          <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-white tracking-tight drop-shadow-md">
            {court.courtName}
          </h2>
        </div>
      </div>
      ...
      <div className="flex items-center justify-between pb-2.5 border-b border-fog/70 flex-wrap gap-2">
